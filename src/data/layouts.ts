...
export const layouts: Layout[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    id: 'masonry-grid',
    name: 'Masonry Grid',
    description: 'Кирпичная кладка. Pinterest-стиль.',
    structure: 'masonry-grid',
    bestFor: ['blog', 'ecommerce'],
    conflicts: ['admin-panel'],
    icon: 'Columns2',
    techNotes: 'columns: 3 + break-inside: avoid или CSS Grid с masonry'
  },
  {
    id: 'asymmetric-grid',
  ...
  },
  {
    id: 'honeycomb-grid',
    name: 'Honeycomb',
    description: 'Соты. Hexagon-стиль (имитация через Grid).',
    structure: 'honeycomb-grid',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'Hexagon',
    techNotes: 'grid-template-columns: repeat(3, 1fr) + transform: rotate + offset'
  },
  {
    id: 'mosaic-grid',
    name: 'Mosaic Grid',
  ...
  },
  {
    ...
    description: 'Спираль Фибоначчи. Блоки закручиваются от центра.',
    structure: 'fibonacci-spiral',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'RefreshCw',
    techNotes: 'Вложенные квадраты с размерами 1, 1, 2, 3, 5, 8 + rotate для спирали'
  },
  {
  ...
  },
  {
    ...
    description: 'Смесь Masonry и Фибоначчи. Динамичные пропорции.',
    structure: 'fibonacci-masonry',
    bestFor: ['blog', 'ecommerce'],
    conflicts: ['admin-panel', 'landing'],
    icon: 'LayoutList',
    techNotes: 'columns: 3 + height в пропорциях 1, 2, 3, 5, 8'
  },
  {
    id: 'fibonacci-bento',
  ...
  {
    id: 'fibonacci-diagonal',
    name: 'Fibonacci Diagonal',
    description: 'Диагональное расположение блоков в пропорциях Фибоначчи.',
    structure: 'fibonacci-diagonal',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'TrendingUp',
    techNotes: 'transform: skewY + grid-column stagger с пропорциями 1, 2, 3, 5'
  },
  {
    id: 'fibonacci-steps',
  ...
  {
    id: 'fibonacci-radiant',
    name: 'Fibonacci Radiant',
    description: 'Радиальное расположение от центра. Блоки расходятся лучами.',
    structure: 'fibonacci-radiant',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel', 'ecommerce'],
    icon: 'Sun',
    techNotes: 'transform: rotate(N * 36deg) + размеры в пропорциях Фибоначчи'
  },
  {
  ...
  },
  {
    ...
    description: 'Вложенные блоки. Матрёшка в пропорциях Фибоначчи.',
    structure: 'fibonacci-nested',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'SquareDashedBottom',
    techNotes: 'Вложенные grid с размерами 8 > 5 > 3 > 2 > 1'
  },
  {
    id: 'fibonacci-triangle',
    name: 'Fibonacci Triangle',
    description: 'Треугольник Паскаля на основе чисел Фибоначчи.',
    structure: 'fibonacci-triangle',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel', 'ecommerce'],
    icon: 'Triangle',
    techNotes: 'Строки: 1, 2, 3, 5, 8 элементов с justify-center'
  },
  ...
  },
  {
    id: 'spiral-grid',
    name: 'Spiral Grid',
    description: 'Спиральная структура. Динамичный визуальный поток.',
    structure: 'spiral-grid',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel', 'ecommerce'],
    icon: 'RefreshCw',
    techNotes: 'Вложенные grid с rotate + scale для создания спирали'
  },
  {
    id: 'phi-grid',
    name: 'Phi Grid (φ)',
  ...
  },
  {
    id: 'root-rectangle',
    name: 'Root Rectangle',
    description: 'Корневые прямоугольники (√2, √3, √4). DIN стандарт.',
    structure: 'root-rectangle',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'RectangleHorizontal',
    techNotes: 'aspect-ratio: √2 (1.414), √3 (1.732), √4 (2)'
  },
  {
    id: 'dynamic-symmetry',
    name: 'Dynamic Symmetry',
    description: 'Динамическая симметрия. Энергичные диагонали.',
    structure: 'dynamic-symmetry',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel', 'ecommerce'],
    icon: 'Diamond',
    techNotes: 'transform: rotate(45deg) + пропорции на основе √5'
  },
  {
    id: 'harmonic-series',
  ...
  },
  {
    id: 'pi-grid',
    name: 'Pi Grid (π)',
    description: 'Пропорции числа Пи (π = 3.14159...). Круг в квадрате.',
    structure: 'pi-grid',
    bestFor: ['landing', 'blog'],
    conflicts: ['admin-panel'],
    icon: 'Pi',
    techNotes: 'grid-template-columns: 3.14159fr 1fr или радиальное деление'
  },
  {
    id: 'prime-grid',
    name: 'Prime Grid',
...
export const layoutCategories: LayoutCategory[] = [
  ...
  },
  {
    ...
    layouts: [
      ...
      'fibonacci-diagonal', 'fibonacci-steps', 'fibonacci-radiant',
      'fibonacci-cascade', 'fibonacci-nested', 'fibonacci-triangle'
    ]
  },
  {
    id: 'math',
